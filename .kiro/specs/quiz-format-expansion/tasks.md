...
- [ ] 1. Extend schema enums and optional fields in content-collections.ts
...
- [ ] 2. Implement schema refinement validations
  ...
  - [ ] 2.2 Add refinement for options count validation per format
  ...
  - [ ] 2.3 Add refinement for difficulty-format constraint validation
    - `basics`/`advanced`: only `choices` allowed
    - `expert`: `choices`, `multi_select`, `ordering` allowed
    - `master`: all formats allowed
    - _Requirements: 9.1, 9.2_

- [ ] 3. Update CONTRIBUTING.md Section 0 (Category, Format, and Difficulty Settings)
...
- [ ] 4. Update CONTRIBUTING.md Section 1 (File Placement)
  - Add `speed_compare` to the `[category]` path template list
  - _Requirements: 4.1_

- [ ] 5. Update CONTRIBUTING.md Section 2 (Frontmatter Property Table)
...
- [ ] 6. Update CONTRIBUTING.md Section 3 (Category-Specific Special Data)
...
- [ ] 9. Create basics level speed_compare quizzes (10 files)
...
- [ ] 10. Create advanced level speed_compare quizzes (10 files)
  - [ ] 10.1 Create speed_advanced_01.mdx through speed_advanced_10.mdx
...
- [ ] 11. Create expert level speed_compare quizzes (10 files)
  - [ ] 11.1 Create speed_expert_01.mdx through speed_expert_10.mdx
...
- [ ] 12. Create master level speed_compare quizzes (10 files)
  - [ ] 12.1 Create speed_master_01.mdx through speed_master_10.mdx
...
- [ ] 13. Checkpoint - Verify content creation
