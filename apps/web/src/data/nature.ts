...
export const natureStringToObject = (nature: Nature | null) =>
  match(nature)
    ...
    .with("Bashful", () => ({ plus: null, minus: null }))
    .with("Bold", () => ({ plus: "def", minus: "atk" }))
    .with("Brave", () => ({ plus: "atk", minus: "spe" }))
    .with("Calm", () => ({ plus: "spd", minus: "atk" }))
    .with("Careful", () => ({ plus: "spd", minus: "spa" }))
    .with("Docile", () => ({ plus: null, minus: null }))
    .with("Gentle", () => ({ plus: "spd", minus: "def" }))
    .with("Hardy", () => ({ plus: null, minus: null }))
    .with("Hasty", () => ({ plus: "spe", minus: "def" }))
    .with("Impish", () => ({ plus: "def", minus: "spa" }))
    .with("Jolly", () => ({ plus: "spe", minus: "spa" }))
    .with("Lax", () => ({ plus: "def", minus: "spd" }))
    .with("Lonely", () => ({ plus: "atk", minus: "def" }))
    .with("Mild", () => ({ plus: "spa", minus: "def" }))
    .with("Modest", () => ({ plus: "spa", minus: "atk" }))
    .with("Naive", () => ({ plus: "spe", minus: "spd" }))
    .with("Naughty", () => ({ plus: "atk", minus: "spd" }))
    .with("Quiet", () => ({ plus: "spa", minus: "spe" }))
    .with("Quirky", () => ({ plus: null, minus: null }))
    .with("Rash", () => ({ plus: "spa", minus: "spd" }))
    .with("Relaxed", () => ({ plus: "def", minus: "spe" }))
    .with("Sassy", () => ({ plus: "spd", minus: "spe" }))
    .with("Serious", () => ({ plus: null, minus: null }))
...
export const parseNature = (
  nature: string,
): Result<{ readonly plus: Status | null; readonly minus: Status | null }> =>
  match(nature)
    .with("Adamant", () => right({ plus: "atk" as const, minus: "spa" as const }))
    .with("Bashful", () => right({ plus: null, minus: null }))
    .with("Bold", () => right({ plus: "def" as const, minus: "atk" as const }))
    ...
    .with("Docile", () => right({ plus: null, minus: null }))
    .with("Gentle", () => right({ plus: "spd" as const, minus: "def" as const }))
    .with("Hardy", () => right({ plus: null, minus: null }))
    .with("Hasty", () => right({ plus: "spe" as const, minus: "def" as const }))
    .with("Impish", () => right({ plus: "def" as const, minus: "spa" as const }))
    .with("Jolly", () => right({ plus: "spe" as const, minus: "spa" as const }))
    .with("Lax", () => right({ plus: "def" as const, minus: "spd" as const }))
    .with("Lonely", () => right({ plus: "atk" as const, minus: "def" as const }))
    .with("Mild", () => right({ plus: "spa" as const, minus: "def" as const }))
    ...
    .with("Quirky", () => right({ plus: null, minus: null }))
    .with("Rash", () => right({ plus: "spa" as const, minus: "spd" as const }))
    .with("Relaxed", () => right({ plus: "def" as const, minus: "spe" as const }))
    .with("Sassy", () => right({ plus: "spd" as const, minus: "spe" as const }))
    .with("Serious", () => right({ plus: null, minus: null }))
